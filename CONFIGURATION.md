...
ordering:
  ...
  fallback_depth: 3       # Ensure a low-bitrate fallback appears within the first N entries
  similar_score_delta: 5  # Score window used for provider diversity and bitrate tie-breaks

Optional regex-based channel selection (auto-generated by the Web App)
----------------------------------------------------------------------
