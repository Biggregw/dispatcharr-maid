...
Full interactive web application for Dispatcharr Scout
...
def _render_auth_error(error_message):
    ...
    return (
        ...
        <head>
            ...
            <title>Dispatcharr Scout - Connection Required</title>
        ...
        <body>
            <div class="card">
                <div class="brand" aria-label="Dispatcharr Scout">
                    <img class="brand-logo" src="/static/logo.svg" alt="Dispatcharr Scout">
                    <div class="brand-text" style="color:#111827;">
                        <h1 style="font-size:1.6em;">Dispatcharr Scout</h1>
                ...
                <details>
                    ...
                    <p>
                        ...
                        - Ensure Dispatcharr and Scout are on the same Docker network.<br>
...
def api_results_streams():
    ...
    Query params:
      - job_id: optional
      - limit: int (default 500, max 5100)
    ...
    try:
        ...
        try:
            limit_i = max(1, min(5100, int(limit)))
        except (TypeError, ValueError):
            limit_i = 500
        try:
...
if __name__ == '__main__':
    print("\n" + "="*70)
    print("🧹 DISPATCHARR SCOUT - WEB APPLICATION")
    print("="*70)
    print("\nStarting web application...")
    print("Access the dashboard at: http://localhost:5100")
    print("Or from another device: http://YOUR-SERVER-IP:5100")
