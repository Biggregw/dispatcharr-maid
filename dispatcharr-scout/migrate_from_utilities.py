...
Helper script to migrate from Dispatcharr-Utilities to Dispatcharr-Scout
"""
...
def migrate():
    ...
    print("="*70)
    print("MIGRATION HELPER: Dispatcharr-Utilities → Dispatcharr-Scout")
    print("="*70 + "\n")
    ...
    if not old_path.exists():
        ...
        print("\nPlease ensure this script is run from the Dispatcharr_Scout folder")
